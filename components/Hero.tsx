      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          <h1 className="text-4xl sm:text-6xl font-black text-gray-900 tracking-tight leading-tight">
            ...
            <span className="text-blue-600">Mobiliario Escolar MEC</span>
          </h1>
          ...
          <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link 
              ...
              className="px-8 py-4 bg-white text-blue-600 border-2 border-blue-50 rounded-2xl font-bold text-lg hover:bg-blue-50 transition-all"
            >
